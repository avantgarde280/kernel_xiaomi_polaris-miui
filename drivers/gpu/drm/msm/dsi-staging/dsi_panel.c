	...
	u32 bl_lvl)
{
	...
	if (panel->bl_config.dcs_type_ss_ea || panel->bl_config.dcs_type_ss_eb || panel->bl_config.xiaomi_k9a_36_flag)
...
void dsi_panel_destroy_cmds_packets_buf(struct dsi_panel_cmd_set *set)
{
	u32 i = 0;
	struct dsi_cmd_desc *cmd;
				     ...
				     struct device_node *of_node)
{
	...
	panel->bl_config.samsung_prepare_hbm_flag = of_property_read_bool(of_node,
...
int dsi_panel_parse_elvss_dimming_read_configs(struct dsi_panel *panel)
{
	...
	struct dsi_parser_utils *of_node;
	...
	rc = of_property_read_u32(of_node->data, "qcom,mdss-dsi-panel-elvss-dimming-read-length",
	...
	dsi_panel_parse_cmd_sets_sub(&panel->hbm_fod_on,
				DSI_CMD_SET_DISP_HBM_FOD_ON, of_node);
	...
	dsi_panel_parse_cmd_sets_sub(&panel->hbm_fod_off,
				DSI_CMD_SET_DISP_HBM_FOD_OFF, of_node);
...
static int dsi_panel_parse_elvss_dimming_config(struct dsi_panel *panel)
{
	...
	panel->elvss_dimming_check_enable = of_property_read_bool(of_node->data,
				...
				struct device_node *of_node)
{
	...
	dsi_panel_parse_cmd_sets_sub(&esd_config->offset_cmd,
				DSI_CMD_SET_PANEL_STATUS_OFFSET, of_node);
				     ...
				     struct device_node *of_node)
{
	...
	of_node = &panel->of_node;

	panel->dispparam_enabled = of_node->read_bool(of_node,
	...
	panel->is_tddi_flag = of_node->read_bool(of_node, "qcom,is-tddi-flag");
	panel->f4_51_ctrl_flag = of_node->read_bool(of_node->data,
	...
	panel->fod_dimlayer_enabled = of_node->read_bool(of_node,
	...
	panel->nolp_command_set_backlight_enabled = of_node->read_bool(of_node,
	...
	panel->oled_panel_video_mode = of_node->read_bool(of_node,
	...
	panel->k6_dc_flag = of_node->read_bool(of_node,
